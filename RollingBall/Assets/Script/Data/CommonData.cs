...
public class CommonData
{
    ...
    public static int DEFAULT_JELLY_HEALTH_POINT = 3;
    public static int MAX_JELLY_HEALTH_POINT = 3;
    ...
    public static float IN_GAMEOBJECT_CRASH_DEGREE_GAP = 12;
    public static int TOUCH_MINUS_HP = 1;
    public static int TURN_TRACK_MINUS_HP = 1;

    public static int COIN_ITEM_CRAETE_PERCENT = 10;

    public static int GAME_START_AD_VIEW_COUNT = 3;
    public static int GAME_END_AD_VIEW_COUNT = 2;
